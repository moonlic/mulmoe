...
from models.sparse_moe import DynamicSparseMoeBlock
                ...
                for k in range(
                    ...
                    if not moe_layers == "attn":
                        ...
                        self.pipe.unet.down_blocks[i].attentions[j].transformer_blocks[
                            k
                        ].ff = DynamicSparseMoeBlock(config, layers)
                    if not moe_layers == "ff":
                        ...
                        self.pipe.unet.down_blocks[i].attentions[j].transformer_blocks[
                            k
                        ].attn1.to_q = DynamicSparseMoeBlock(config, layers)
                        ...
                        self.pipe.unet.down_blocks[i].attentions[j].transformer_blocks[
                            k
                        ].attn1.to_k = DynamicSparseMoeBlock(config, layers)
                        ...
                        self.pipe.unet.down_blocks[i].attentions[j].transformer_blocks[
                            k
                        ].attn1.to_v = DynamicSparseMoeBlock(config, layers)
                        ...
                        self.pipe.unet.down_blocks[i].attentions[j].transformer_blocks[
                            k
                        ].attn2.to_q = DynamicSparseMoeBlock(config, layers)
                        ...
                        self.pipe.unet.down_blocks[i].attentions[j].transformer_blocks[
                            k
                        ].attn2.to_k = DynamicSparseMoeBlock(config, layers)
                        ...
                        self.pipe.unet.down_blocks[i].attentions[j].transformer_blocks[
                            k
                        ].attn2.to_v = DynamicSparseMoeBlock(config, layers)
            ...
            for j in range(len(unet.down_blocks[i].attentions)):
                for k in range(
                    ...
                    if not moe_layers == "attn":
                        ...
                        unet.down_blocks[i].attentions[j].transformer_blocks[k].ff = (
                            DynamicSparseMoeBlock(config, layers)
                        )
                    if not moe_layers == "ff":
                        ## Attns
                        config = {
